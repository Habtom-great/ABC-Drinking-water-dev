...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $insert_query = "INSERT INTO users (first_name, last_name, middle_name, email, telephone, address, password, role) 
                     VALUES ('$first_name', '$last_name', '$middle_name', '$email', '$telephone', '$address', '$password', '$role')";
    ...
    header("Location: add_user.php"); // Redirect back to the add user form
    exit();
}
?>
...
<body>
 ...
 <!-- Footer -->
 <footer class="footer">
  &copy; <?php echo date("Y"); ?> Add User - All Rights Reserved.
 </footer>
